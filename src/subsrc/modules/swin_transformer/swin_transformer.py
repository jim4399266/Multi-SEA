...
default_cfgs = {
    ...
    'swin_base_patch4_window12_384_in22k': _cfg(
        ...
        path='/home/tzj/pretrained_models/swin-transformer/swin_base_patch4_window12_384_22k.pth',
        input_size=(3, 384, 384), crop_pct=1.0, num_classes=21841),

    'swin_base_patch4_window7_224_in22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window7_224_22k.pth',
        path='/home/tzj/pretrained_models/swin-transformer/swin_base_patch4_window7_224_22k.pth',
        num_classes=21841),

    'swin_large_patch4_window12_384_in22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window12_384_22k.pth',
        path='/home/tzj/pretrained_models/swin-transformer/swin_large_patch4_window12_384_22k.pth',
        input_size=(3, 384, 384), crop_pct=1.0, num_classes=21841),

    'swin_large_patch4_window7_224_in22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window7_224_22k.pth',
        path='/home/tzj/pretrained_models/swin-transformer/swin_large_patch4_window7_224_22k.pth',
        num_classes=21841),
...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        avg_output = [self.avgpool(v.transpose(1,2)).squeeze() for v in nums_x]

        #for i, num_x in enumerate(nums_x):
        #    nums_x[i] = self.norm(num_x)

        #x = self.norm(x)  # B L C
        return avg_output, nums_x

    def forward(self, x):
        avg_output, nums_x = self.forward_features(x)
        # swin_transformer 与Vit输出不同，这里统一一下
        # avg_output和nums_x分别是swin_transformer每层的平均向量和细粒度向量
        last_hidden_state = torch.cat([avg_output[-1].unsqueeze(1), nums_x[-1]], dim=1)
        pooler_output = avg_output[-1]
        hidden_states = [torch.cat([a.unsqueeze(1), x], dim=1) for a, x in zip(avg_output, nums_x)]
